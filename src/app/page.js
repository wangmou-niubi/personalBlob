...
const Home = (props) => {
    ...
    useEffect(() => {
        ...
        function transformElementCard(x, y) {
            let box = cardelement.getBoundingClientRect();
        ...
        cardelement.addEventListener("mousemove", (e) => {
            window.requestAnimationFrame(function () {
                transformElementCard(e.clientX, e.clientY);
            });
        });
                            ...
                            <div className={'introduction-container cursor-pointer'}>
                                ...
                                <div className={'translate-title translate-font'} style={{ '--translatevar': '100px' }}>
                                    <div className={'basic-bottom'}>
                                        <i className={'iconfont icon-position'}></i>
                                        <Link href={'/blob'}>前往博客</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
